...
data_path = Path("../data/frcnn_3channel/sagital")
...
cfg.OUTPUT_DIR = "../data/frcnn_3channel/sagital/each_channel_empty"
...
loss_df.to_csv(data_path/"loss_each_channel_empty")
