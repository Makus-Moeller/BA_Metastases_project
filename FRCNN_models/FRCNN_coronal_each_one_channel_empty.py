...
data_path = Path("../data/frcnn_3channel/coronal")
...
def get_board_dicts(imgdir, data_list):
    json_file = Path(imgdir / "metastasis_annotations_coco_train_old_anno.json")
...
cfg.OUTPUT_DIR = "../data/frcnn_3channel/coronal/each_channel_empty_aug"
...
loss_df.to_csv(data_path/"loss_each_channel_empty_aug")
