...
for axi_scan_anony in data_path.glob('nii/anonymized/test/*/axi/PET_*'): 
  scan = np.load(axi_scan_anony)
  Xt_pet.append(expand_np_image_to_3_channels(scan))
  yt_pet.append(1.0)

for axi_scan_control in data_path.glob('nii/controls/test/*/axi/PET_*'): 
...
for axi_scan_anony in data_path.glob('nii/anonymized/test/*/axi/CT_*'): 
  scan = np.load(axi_scan_anony)
  Xt_ct.append(expand_np_image_to_3_channels(scan))
  yt_ct.append(1.0)

for axi_scan_control in data_path.glob('nii/controls/test/*/axi/CT_*'): 
  scan = np.load(axi_scan_control)
  Xt_ct.append(expand_np_image_to_3_channels(scan))
  yt_ct.append(0.0)
...
for axi_scan_anony in data_path.glob('nii/anonymized/test/*/axi/norm_*'): 
  scan = np.load(axi_scan_anony)
  Xt_norm.append(expand_np_image_to_3_channels(scan))
  yt_norm.append(1.0)

for axi_scan_control in data_path.glob('nii/controls/test/*/axi/norm_*'): 
  scan = np.load(axi_scan_control)
  Xt_norm.append(expand_np_image_to_3_channels(scan))
  yt_norm.append(0.0)
...
for axi_scan_anony in data_path.glob('nii/anonymized/test/*/axi/three_*'): 
  scan = np.load(axi_scan_anony)
  Xt_three.append(scan)
  yt_three.append(1.0)

for axi_scan_control in data_path.glob('nii/controls/test/*/axi/three_*'): 
  scan = np.load(axi_scan_control)
  Xt_three.append(scan)
  yt_three.append(0.0)
...
resnet_model_pet.load_state_dict(torch.load('axi_pet_model.pt'))
...
resnet_model_ct.load_state_dict(torch.load('axi_ct_model.pt'))
...
resnet_model_norm.load_state_dict(torch.load('axi_norm_pet_model.pt'))
...
resnet_model_three.load_state_dict(torch.load('axi_three_channel_model.pt'))
