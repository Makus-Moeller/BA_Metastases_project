...
#TRAIN
for axi_scan_anony in data_path.glob('nii/anonymized/train/*/axi/three*'): 
...
for axi_scan_control in data_path.glob('nii/controls/train/*/axi/three*'): 
...
#VALIDATION
for axi_scan_anony in data_path.glob('nii/anonymized/val/*/axi/three*'):
    X_valid.append(np.load(axi_scan_anony))
    y_valid.append(1.0)

for axi_scan_control in data_path.glob('nii/controls/val/*/axi/three*'):
...
#TEST
for axi_scan_anony in data_path.glob('nii/anonymized/test/*/axi/three*'):
    X_test.append(np.load(axi_scan_anony))
    y_test.append(1.0)

for axi_scan_control in data_path.glob('nii/controls/test/*/axi/three*'):
