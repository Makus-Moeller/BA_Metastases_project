...
#TRAIN
for axi_scan_anony in data_path.glob('nii/anonymized/train/*/sagi/three*'): 
...
for axi_scan_control in data_path.glob('nii/controls/train/*/sagi/three*'): 
...
#VALIDATION
for axi_scan_anony in data_path.glob('nii/anonymized/val/*/sagi/three*'):
    X_valid.append(np.load(axi_scan_anony))
    y_valid.append(1.0)

for axi_scan_control in data_path.glob('nii/controls/val/*/sagi/three*'):
...
#TEST
for axi_scan_anony in data_path.glob('nii/anonymized/test/*/sagi/three*'):
    X_test.append(np.load(axi_scan_anony))
    y_test.append(1.0)

for axi_scan_control in data_path.glob('nii/controls/test/*/sagi/three*'):
